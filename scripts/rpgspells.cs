...
$spellData[WaterSurge, Image] = WaterSurgeProjectile;
$spelldata[WaterSurge, DamageMod] = 55;
$spelldata[WaterSurge, NumEffect] = "";
$spelldata[WaterSurge, Test] = 1;
$spelldata[WaterSurge, Delay] = 10;
$spelldata[WaterSurge, Element] = "Water";
$spelldata[WaterSurge, RecoveryTime] = 3000;
$spelldata[WaterSurge, Type] = LinearFlareProjectile;
$spelldata[WaterSurge, Cost] = 15;
$spelldata[WaterSurge, Skill] = $Skill::OffensiveCasting;
$spelldata[WaterSurge, Function] = "DoSpellCast";
...
$spelldata[FullHeal, Image] = HealAuraEmitter2;
$spelldata[FullHeal, DamageMod] = -350;
$spelldata[FullHeal, NumEffect] = "";
$spelldata[FullHeal, Test] = 1;
$spelldata[FullHeal, Delay] = 1500;
$spelldata[FullHeal, RecoveryTime] = 10000;
$spelldata[FullHeal, Type] = Emitter;
$spelldata[FullHeal, Cost] = 45;
$spelldata[FullHeal, Function] = "DoDSpellCastLOS";
$spelldata[FullHeal, Skill] = $Skill::DefensiveCasting;

$spelldata[MassHeal, Image] = HealAuraEmitter2;
$spelldata[MassHeal, DamageMod] = -700;
$spelldata[MassHeal, NumEffect] = "";
$spelldata[MassHeal, Test] = 1;
$spelldata[MassHeal, Delay] = 1500;
$spelldata[MassHeal, RecoveryTime] = 12000;
$spelldata[MassHeal, Type] = Emitter;
$spelldata[MassHeal, Cost] = 75;
$spelldata[MassHeal, Function] = "DoDSpellCastLOS";
$spelldata[MassHeal, Skill] = $Skill::DefensiveCasting;
//Neutral Spells
...
function DoSpellTeleport(%client, %spell, %sdata, %params)
{
	...
	%client.player.setPosition(%closest.getTransform());
...
function DoSpellTransport(%client, %spell, %sdata, %params)
{
	...
	if(%tele != 0)
	{
		%client.player.setPosition(%tele.getTransform());
...
function DoSpellGuildTeleportLOS(%client, %spell, %sdata, %params)
{
	...
	if(%tele != false)
	{
		%target.player.setPosition(%tele.getTransform());
		UseSkill(%client, $skill::NeutralCasting, true, true, 2, false);
	}
	else
	{
