...
function DefineItems()
{
	...
	$weaponList[$numweapons++] = "Dagger";
	$weaponList[$numweapons++] = "Mace";
	$weaponList[$numweapons++] = "Bardiche";
	$weaponList[$numweapons++] = "Gladius";
	$weaponList[$numweapons++] = "WarHammer";
	$weaponList[$numweapons++] = "WarMaul";
	$weaponList[$numweapons++] = "Claymore";
	$weaponList[$numweapons++] = "GreatClaymore";
	$weaponList[$numweapons++] = "Katana";
	$weaponList[$numweapons++] = "BastardSword";
	$weaponList[$numweapons++] = "PickAxe";
	$weaponList[$numweapons++] = "Knife";
	$weaponList[$numweapons++] = "Hatchet";
	$weaponList[$numweapons++] = "SpikedClub";
	$weaponList[$numweapons++] = "QuarterStaff";
	$weaponList[$numweapons++] = "ShortSword";
	$weaponList[$numweapons++] = "BroadSword";
	$weaponList[$numweapons++] = "Club";
	$weaponList[$numweapons++] = "IceBroadsword";
	$weaponList[$numweapons++] = "FireBroadsword";
	$weaponList[$numweapons++] = "WaterBroadsword";
	$weaponList[$numweapons++] = "WarAxe";
	$weaponList[$numweapons++] = "Longsword";
	$weaponlist[$numweapons++] = "spear";
	$weaponList[$numweapons++] = "Hammerpick";
	$weaponList[$numweapons++] = "BattleAxe";
	$weaponList[$numweapons++] = "Sling";
	$weaponList[$numweapons++] = "Trident";
	$weaponList[$numweapons++] = "BastardSword";
	$weaponList[$numweapons++] = "WarHammer";
	$weaponList[$numweapons++] = "Katar";
    $weaponList[$numweapons++] = "LightningSword";
    $weaponList[$numweapons++] = "ElementalScepter";
    $weaponList[$numweapons++] = "NatureBow";
    $weaponList[$numweapons++] = "SpiritualBow";
    $weaponList[$numweapons++] = "SpiritualDagger";
...
// not yet used
	...
	$ItemType[ElementalScepter] = "weapon";
	$ItemSubType[ElementalScepter] = $SwordAccessoryType;
	$ItemDesc[ElementalScepter] = "Elemental Scepter";
	$ItemSize[ElementalScepter] = "small";
	$ItemBaseWeight[ElementalScepter] = 0.5;
	$ItemBaseDelay[ElementalScepter] = 2.0 * $ADnDdelayToRPG;
	$ItemBaseSpecialVar[ElementalScepter] = "6 400r800";
	$ItemBaseRange[ElementalScepter] = $minRange + 3.0;
	$ItemDamageType[ElementalScepter] = $DamageType::Piercing;
	$itemSwingSound[ElementalScepter] = "Swing4";
	$itemHitFlesh[ElementalScepter]   = "WeaponHit1";
	$itemHitWall[ElementalScepter]    = "";
	$PrefixExclusions[ElementalScepter] = ",";
	$SuffixExclusions[ElementalScepter] = "3,";
	$SkillType[ElementalScepter] = $SkillPiercing;
	$DataBlock[ElementalScepter] = "ElementalScepter";
	$shop::BuyPrice[ElementalScepter] = 800000;
	$item::smith[ElementalScepter,3] = "WaterElement 1 EarthElement 1 FireElement 1 AirElement 1";
	$item::smith[ElementalScepter,4] = "WaterElement 3 EarthElement 3 FireElement 3 AirElement 3";
	$item::smith[ElementalScepter,5] = "WaterElement 5 EarthElement 5 FireElement 5 AirElement 5";
	...
	$ItemType[LightningSword] = "weapon";
	$ItemSubType[LightningSword] = $SwordAccessoryType;
	$ItemDesc[LightningSword] = "Elemental Lightning Claymore";
	$ItemSize[LightningSword] = "small";
	$ItemBaseWeight[LightningSword] = 0.5;
	$ItemBaseDelay[LightningSword] = 2.5 * $ADnDdelayToRPG;
	$ItemBaseSpecialVar[LightningSword] = "6 100r400";
	$ItemBaseRange[LightningSword] = $minRange + 4.0;
	$ItemDamageType[LightningSword] = $DamageType::Slashing;
	$itemSwingSound[LightningSword] = "Swing4";
	$itemHitFlesh[LightningSword]   = "WeaponHit1";
	$itemHitWall[LightningSword]    = "";
	$PrefixExclusions[LightningSword] = ",";
	$SuffixExclusions[LightningSword] = "3,";
	$SkillType[LightningSword] = $Skill::Slashing;
	$DataBlock[LightningSword] = "GreatClaymore";
	$shop::BuyPrice[LightningSword] = 100000;
	...
	$shop::BuyPrice[Claymore] = 90000;
 	...
 	$ItemType[SpiritualDagger] = "weapon";
	$ItemSubType[SpiritualDagger] = $SwordAccessoryType;
	$ItemDesc[SpiritualDagger] = "Spiritual Dagger";
	$ItemSize[SpiritualDagger] = "small";
	$ItemBaseWeight[SpiritualDagger] = 0.5;
	$ItemBaseDelay[SpiritualDagger] = 1.5 * $ADnDdelayToRPG;
	$ItemBaseSpecialVar[SpiritualDagger] = "6 25r200";
	$ItemBaseRange[SpiritualDagger] = $minRange + 1.0;
	$ItemDamageType[SpiritualDagger] = $DamageType::Piercing;
	$itemSwingSound[SpiritualDagger] = "Swing4";
	$itemHitFlesh[SpiritualDagger]   = "WeaponHit1";
	$itemHitWall[SpiritualDagger]    = "";
	$PrefixExclusions[SpiritualDagger] = ",";
	$SuffixExclusions[SpiritualDagger] = "3,";
	$SkillType[SpiritualDagger] = $Skill::Piercing;
	$DataBlock[SpiritualDagger] = "Dagger";
	$shop::BuyPrice[SpiritualDagger] = 75000;

    $ItemType[NatureBow] = "weapon";
	$ItemSubType[NatureBow] = $BludgeonAccessoryType;
	$ItemDesc[NatureBow] = "Nature Bow";
	$ItemSize[NatureBow] = "small";
	$ItemBaseWeight[NatureBow] = 1.0;
	$ItemBaseDelay[NatureBow] = 2 * $ADnDdelayToRPG;
	$ItemBaseSpecialVar[NatureBow] = "6 10r50";
	$ItemBaseRange[NatureBow] = $minRange + 2.0;
	$ItemDamageType[NatureBow] = $DamageType::Archery;
	$itemSwingSound[NatureBow] = "Swing4";
	$itemHitFlesh[NatureBow]   = "WeaponHit1";
	$itemHitWall[NatureBow]    = "";
	$itemAmmo[NatureBow] = "SpiritualArrow";
	$PrefixExclusions[NatureBow] = ",";
	$SuffixExclusions[NatureBow] = ",";
	$SkillType[NatureBow] = $SkillArchery;
	$DataBlock[NatureBow] = "Longbow";
	$shop::BuyPrice[NatureBow] = 7500;
 
    $ItemType[SpiritualBow] = "weapon";
	$ItemSubType[SpiritualBow] = $BludgeonAccessoryType;
	$ItemDesc[SpiritualBow] = "Spiritual Bow";
	$ItemSize[SpiritualBow] = "small";
	$ItemBaseWeight[SpiritualBow] = 1.0;
	$ItemBaseDelay[SpiritualBow] = 2 * $ADnDdelayToRPG;
	$ItemBaseSpecialVar[SpiritualBow] = "6 75r125";
	$ItemBaseRange[SpiritualBow] = $minRange + 2.0;
	$ItemDamageType[SpiritualBow] = $DamageType::Archery;
	$itemSwingSound[SpiritualBow] = "Swing4";
	$itemHitFlesh[SpiritualBow]   = "WeaponHit1";
	$itemHitWall[SpiritualBow]    = "";
	$itemAmmo[SpiritualBow] = "DarkSpectreArrow";
	$PrefixExclusions[SpiritualBow] = ",";
	$SuffixExclusions[SpiritualBow] = ",";
	$SkillType[SpiritualBow] = $SkillArchery;
	$DataBlock[SpiritualBow] = "SpiritualBow";
	$shop::BuyPrice[SpiritualBow] = 25000;
    ...
    $itemList[$numItems++] = "SpiritualArrow";
    $itemList[$numItems++] = "DarkSpectreArrow";
    ...
    $itemList[$numItems++] = "WaterElement";
    $itemList[$numItems++] = "FireElement";
    $itemList[$numItems++] = "AirElement";
    $itemList[$numItems++] = "EarthElement";
    $itemList[$numItems++] = "VoltrueFireCrystal";
    $itemList[$numItems++] = "MagmusDarkSpirit";
    ...
    $ArrowList[$numarrows++] = "SpiritualArrow";
    $ArrowList[$numarrows++] = "DarkSpectreArrow";
	...
	$ItemType[SpiritualArrow] = "Item";
	$ItemSubType[SpiritualArrow] = $BeltAccessoryType;
	$ItemDesc[SpiritualArrow] = "Spiritual Arrow";
	$ItemSize[SpiritualArrow] = "tiny";
	$ItemBaseWeight[SpiritualArrow] = 0.01;
	$ItemBaseSpecialVar[SpiritualArrow] = "6 10r20";
	$PrefixExclusions[SpiritualArrow] = ",";
	$SuffixExclusions[SpiritualArrow] = ",";
	$itemIsArrow[SpiritualArrow] = true;
	$DataBlock[SpiritualArrow] = "basicarrow";
	$shop::BuyPrice[SpiritualArrow] = 50;
 
	$ItemType[DarkSpectreArrow] = "Item";
	$ItemSubType[DarkSpectreArrow] = $BeltAccessoryType;
	$ItemDesc[DarkSpectreArrow] = "Dark Spectre Arrow";
	$ItemSize[DarkSpectreArrow] = "tiny";
	$ItemBaseWeight[DarkSpectreArrow] = 0.01;
	$ItemBaseSpecialVar[DarkSpectreArrow] = "6 25r50";
	$PrefixExclusions[DarkSpectreArrow] = ",";
	$SuffixExclusions[DarkSpectreArrow] = ",";
	$itemIsArrow[DarkSpectreArrow] = true;
	$DataBlock[DarkSpectreArrow] = "basicarrow";
	$shop::BuyPrice[DarkSpectreArrow] = 375;
	...
	$ItemType[WaterElement] = "item";
	$ItemSubType[WaterElement] = $BeltAccessoryType;
	$ItemDesc[WaterElement] = "Water Element";
	$ItemSize[WaterElement] = "small";
	$ItemBaseWeight[WaterElement] = 1.0;
	$ItemBaseSpecialVar[WaterElement] = "";
	$PrefixExclusions[WaterElement] = ",";
	$SuffixExclusions[WaterElement] = ",";
	$DataBlock[WaterElement] = "armor1";
	$shop::BuyPrice[WaterElement] = 100000;
 
	$ItemType[FireElement] = "item";
	$ItemSubType[FireElement] = $BeltAccessoryType;
	$ItemDesc[FireElement] = "Fire Element";
	$ItemSize[FireElement] = "small";
	$ItemBaseWeight[FireElement] = 1.0;
	$ItemBaseSpecialVar[FireElement] = "";
	$PrefixExclusions[FireElement] = ",";
	$SuffixExclusions[FireElement] = ",";
	$DataBlock[FireElement] = "armor1";
	$shop::BuyPrice[FireElement] = 100000;
 
	$ItemType[VoltrueFireCrystal] = "item";
	$ItemSubType[VoltrueFireCrystal] = $BeltAccessoryType;
	$ItemDesc[VoltrueFireCrystal] = "Voltrue Realm Fire Crystal";
	$ItemSize[VoltrueFireCrystal] = "small";
	$ItemBaseWeight[VoltrueFireCrystal] = 1.0;
	$ItemBaseSpecialVar[VoltrueFireCrystal] = "";
	$PrefixExclusions[VoltrueFireCrystal] = ",";
	$SuffixExclusions[VoltrueFireCrystal] = ",";
	$DataBlock[VoltrueFireCrystal] = "armor1";
	$shop::BuyPrice[VoltrueFireCrystal] = 1;
 
    $ItemType[MagmusDarkSpirit] = "item";
	$ItemSubType[MagmusDarkSpirit] = $BeltAccessoryType;
	$ItemDesc[MagmusDarkSpirit] = "Dark Spirit of Fire Lord Magmus";
	$ItemSize[MagmusDarkSpirit] = "small";
	$ItemBaseWeight[MagmusDarkSpirit] = 1.0;
	$ItemBaseSpecialVar[MagmusDarkSpirit] = "";
	$PrefixExclusions[MagmusDarkSpirit] = ",";
	$SuffixExclusions[MagmusDarkSpirit] = ",";
	$DataBlock[MagmusDarkSpirit] = "armor1";
	$shop::BuyPrice[MagmusDarkSpirit] = 1;
 
	$ItemType[AirElement] = "item";
	$ItemSubType[AirElement] = $BeltAccessoryType;
	$ItemDesc[AirElement] = "Air Element";
	$ItemSize[AirElement] = "small";
	$ItemBaseWeight[AirElement] = 1.0;
	$ItemBaseSpecialVar[AirElement] = "";
	$PrefixExclusions[AirElement] = ",";
	$SuffixExclusions[AirElement] = ",";
	$DataBlock[AirElement] = "armor1";
	$shop::BuyPrice[AirElement] = 100000;
 
	$ItemType[EarthElement] = "item";
	$ItemSubType[EarthElement] = $BeltAccessoryType;
	$ItemDesc[EarthElement] = "Earth Element";
	$ItemSize[EarthElement] = "small";
	$ItemBaseWeight[EarthElement] = 1.0;
	$ItemBaseSpecialVar[EarthElement] = "";
	$PrefixExclusions[EarthElement] = ",";
	$SuffixExclusions[EarthElement] = ",";
	$DataBlock[EarthElement] = "armor1";
	$shop::BuyPrice[EarthElement] = 100000;
	//##################################Mining Items######################
...
function DefineItemDatas()
{
    ...
    //############################################################
		datablock ParticleData(SpiritBowParticle2)
		{
		    dragCoefficient = 0;
		    gravityCoefficient = 0;
		    windCoefficient = 0;
		    ...
		    times[1] = 0.25;
		    times[2] = 1;
		    colors[0] = "71 60 139 0.250000";
		    colors[1] = "131 111 255 0.169355";
		    colors[2] = "1.000000 1.000000 1.000000 0.411290";
		    sizes[0] = 0.169355;
		    sizes[1] = 0.33871;
		    sizes[2] = 0;
		...
		datablock ParticleEmitterData(SpiritualEmitter6)
		{
		    ejectionPeriodMS = 5;
		    periodVarianceMS = 1;
		    ejectionVelocity = 10;
		    ...
		    orientParticles= 0;
		    orientOnVelocity = 0;
		    particles = "SpiritBowParticle2";
		};
  
	datablock ShapeBaseImageData(SpiritualBowImage)
	{
		className = WeaponImage;
		shapeFile = "LongBow.dts";
		item = SpiritualBow;
		...
		stateName[2] = "Ready";
		stateTransitionOnTriggerDown[2] = "Draw";
		stateEmitter[2] = "SpiritualEmitter6";
		stateEmitterNode[2] = Muzzlepoint1;
		stateEmitterTime[2] = 5000000;
	...
	datablock ItemData(SpiritualBow)
	{
		className    = Weapon;
		catagory     = "Spawn Items";
		shapeFile    = "longbow.dts";
		image        = SpiritualBowImage;
		mass         = 1;
		elasticity   = 0.2;
		friction     = 0.6;
		pickupRadius = 2;
		pickUpPrefix = "a";
		description  = "SpiritualBow_model";
	...
	// E.Scepter
	//----------------------------------------
	datablock ShapeBaseImageData(ElementalScepterImage)
	{
		className = WeaponImage;
		shapeFile = "katana.dts";
		item = ElementalScepter;
		//offset = "-0.02 -0.01 0.2";
		//extension = $ItemBaseRange[Knife];
	...
	datablock ItemData(ElementalScepter)
	{
		className = Weapon;
		catagory = "Spawn Items";
		shapeFile = "katana.dts";
		image = ElementalScepterImage;
		mass = 1;
		elasticity = 0.2;
		friction = 0.6;
		pickupRadius = 2;
...
function SpiritualBowImage::Load(%this, %obj, %slot)
{
...
function SpiritualBowImage::onFire(%this, %obj, %slot)
{
	%obj.unmountImage(1);
	%client = %obj.client;
	%weaponid = fetchdata(%client, "weaponinhand");
...
function SpiritualBowImage::onUnmount(%this, %obj, %slot)
{
	%obj.unmountImage(1);
	Parent::onUnmount(%this, %obj, %slot);
}
...
function RPGGame::ItemDataonCollision(%game, %data, %obj, %col)
{
	...
	if(%col.getDataBlock().className $= Armor && %col.getState() !$= "Dead")
	{
		if(%col.client)
		{
			if(%obj.pack)
			{
				if( ( %col.client == %obj.dropid || %col.client.rpgname $= %obj.dropname ) || GetSimTime() > %obj.protect )
				{
		
					storedata(%col.client, "COINS", %obj.coins, "inc");
					%lootlist = %obj.coins SPC "coins";
					if(countwords(%obj.loot) == 0)
					{
						%lootlist = %lootlist @ ".";
					}
					else if(countwords(%obj.loot) == 1)
					{
						%lootlist = %lootlist @ ", and ";
					}
					else
						%lootlist = %lootlist @ ", ";
					for(%i = 0; ( %iteml = GetWord(%obj.loot, %i) ) !$= ""; %i++)
					{
						...
						if(%i == countwords(%obj.loot)-1)
						%add = "";
						else
						%add = ", ";
						if(%i == countwords(%obj.loot)-2)
						%add = %add @ "and ";
						%lootlist = %lootlist @ %num SPC %game.getfullitemname(%prefix, %item, %suffix) @ %add;
					}
					MessageClient(%col.client, 'lootmessage', 'You picked up %1 from %2 pack!', %lootlist, %obj.dropname @ "'s");
				}
				else
					{
						MessageClient(%col.client, 'lootmessage', 'This pack is protected, it is owned by %1.', %obj.dropname);
					}
			}
			else
			{
...
function RPGGame::TossLootBag(%game, %client, %loot, %coins, %timer)
{
	...
	//$InvInfo[%id, equipped] = false;
	//$InvInfo[%id, item] = "LootBag";
	//$InvInfo[%id, prefix] = 0;
	//$InvInfo[%id, suffix] = 0;
	if(!%client.isaicontrolled())
		%item.protect = GetSimTime()+(%timer*1000);
	%item.loot = %loot;
	%item.dropid = %client;
	%item.dropname = %client.rpgname;
	%item.coins  = %coins;
	if(%client.isaicontrolled() || %client.player.getState !$= "Dead")
		schedule(900*1000,%item, 'DeleteLootBag', %item);
	MissionCleanup.add(%item);
	%obj = %item;
	%this = %client.player;
...
function ElementalScepterImage::onMount(%data, %obj, %slot) {
   %obj.esChargeLoop = chargeEScep(%obj);
}

function ElementalScepterImage::onUnmount(%data, %obj, %slot) {
   cancel(%obj.esChargeLoop);
}

function ElementalScepterImage::onFire(%data, %obj, %slot) {
   %client = %obj.client;
   //if the charge is at 75 or above, execute the special attack
   if(%obj.escepenergy >= 75) {
      %obj.escepenergy -= 75;
      %obj.lastSpecial = "ElementalScepter";

      %vector = %obj.getEyeVector(); // lets try this
	  %eyeTrans = %obj.getEyeTransform();
	  %pos = posFromTransform(%eyeTrans);
	  %p = new (LinearFlareProjectile)() {
	     dataBlock        	= ESCEPPulse;
   ...
   //continue melee damage normally.
   %itemId = fetchData(%client, "weaponInHand");
   %val = MeleeAttack(%client, Game.GetRange(Game.GetItem(%client, %itemId)), %itemId);
...
function chargeEScep(%player) {
   if(%player.escepenergy < 100) {
      %player.escepenergy++;
   }
   %player.esChargeLoop = schedule(100, 0, chargeEScep, %player);
}
