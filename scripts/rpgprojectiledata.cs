...
datablock ParticleData(PhotonMissileExpPart) {
   ...
   colors[0]     = "0 0.03 1.0 1.0";
   colors[1]     = "0 0.03 1.0 0.0";
   sizes[0]      = 3;
   sizes[1]      = 2;
};
...
datablock LinearFlareProjectileData(WaterSurgeProjectile) {
   scale               = "3 3 3";
